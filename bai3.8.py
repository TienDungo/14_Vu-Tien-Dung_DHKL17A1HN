...
with open('E:/Bài tập lập trình năng cao/Bai_tap_van_dung_chuong_3/heights.txt', 'r') as file:
    heights = [float(line.strip()) for line in file if line.strip()]

with open('E:/Bài tập lập trình năng cao/Bai_tap_van_dung_chuong_3/positions.txt', 'r') as file:
...
print("\nBước 4 - Mảng players sau khi sắp xếp theo chiều cao:\n", sorted_players)
...
print("- Vị trí có chiều cao thấp nhất:", min_height_player['position'], "với chiều cao:", min_height_player['height'])