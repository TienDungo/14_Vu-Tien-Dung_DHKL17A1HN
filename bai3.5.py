...
with open('E:/Bài tập lập trình năng cao/Bai_tap_van_dung_chuong_3/heights_1.txt', 'r') as file:
    height = [float(line.strip()) for line in file if line.strip()]

with open('E:/Bài tập lập trình năng cao/Bai_tap_van_dung_chuong_3/weights_1.txt', 'r') as file:
